...
const RegrasX3 = () => {
    const urlexterna = "https://ww2cup.app.br/backend/regras-x3.php";
    ...
    return (
        <div className="conteudoRegras">
            ...
            <div className="menus-regras">
                <h1 className="titleRegras">REGULAMENTO - X3</h1>
                ...
                <div className="secaoRegras">
                    <h3 onClick={() => setShowEquipes(!showEquipes)}>8 - Equipes</h3>
                    {showEquipes && regras
                        .filter(item => item.cod_grupo === "8")
                        .map((item, i) => (
                            <p key={i}>{item.cod} - {item.desc_regra}</p>
                        ))}
                </div>
