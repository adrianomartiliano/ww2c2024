...
const Quartas = () =>{
    return(
        <div className="eliminatorias-container">
            <h4 className="titleOitavas">Quartas 1</h4>
            <div className="eliminatorias-match">
            <span className="jogador">Corisco</span><span className="placar">0</span>X<span className="placar">0</span><span className="jogador">KILLER_MOUSTER</span>
            </div>
            ...
            <div className="eliminatorias-match">
                <span className="jogador">-P90-</span><span className="placar">0</span>X<span className="placar">0</span><span className="jogador">Joleno matador</span>
            </div>
